...
let
  rgba =
    hex: opacity:
    let
      rgb = lib-custom.conversions.hexToRGB hex;
    in
    "rgba(${
...
/* css */ ''
  ...
  @define-color headerbar_shade_color ${rgba base01 0.07};
  @define-color headerbar_darker_shade_color ${rgba base01 0.07};
  @define-color sidebar_bg_color #${base00};
  @define-color sidebar_fg_color #${base05};
  @define-color sidebar_backdrop_color @window_bg_color;
  @define-color sidebar_shade_color ${rgba base01 0.07};
  ...
  @define-color card_shade_color ${rgba base01 0.07};
  ...
  @define-color popover_shade_color ${rgba base01 0.07};
  @define-color shade_color ${rgba base01 0.07};
  ...
  @define-color light_2 #${base02};
  @define-color light_3 #${base02};
  @define-color light_4 #${base02};
  @define-color light_5 #${base02};
  @define-color dark_1 #${base00};
  @define-color dark_2 #${base00};
