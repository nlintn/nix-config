{ bashInteractive, config, jq, writeShellApplication, ... }:

writeShellApplication {
  name = "hyprtabs";
  runtimeInputs = [ bashInteractive config.wayland.windowManager.hyprland.finalPackage jq ];
  text = ''bash --posix ${builtins.fetchGit {
